...
public class HttpInEventUpdateStackWorkImpl extends AbstractUpdateEventsStackWork<HttpInEvent> {

	WireMockServerDef wireMockServerDef = null;
	Request request = null;
	TreeTraverser treeTraverser = new RecursiveTreeTraverserImpl();

	public HttpInEventUpdateStackWorkImpl(WireMockServerDef wireMockServerDef, Request request) {
